...
@Component({
  selector: "kt-campeonato-editar",
  templateUrl: "./campeonato-editar.component.html",
  styleUrls: ["./campeonato-editar.component.scss"],
})
export class CampeonatoEditarComponent implements OnInit, OnDestroy {
  // Public properties
